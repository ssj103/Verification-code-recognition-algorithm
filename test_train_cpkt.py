...
def read_and_decode(filename):
    ...
    ## tf.train.shuffle_batch is must ensure shape
...
print("Done, return image, label0, label1, label2, label3")

## get images and label
image, label0, label1, label2, label3 = read_and_decode(TFRECORD_FILE)

## Use shuffle_batch to randomly mess up data
...
with tf.Session() as sess:
    ...
    ## Data input network to get output value
    logits0,logits1,logits2,logits3,end_points = train_network_fn(X)
    print("Done, train_network_fn")
    
    ## Turn the label into a form of one_hot
